<template>
  <transition name="fade-slide">
    <div 
      ...
      class="fixed bottom-6 left-6 z-[9990] max-w-[320px] pointer-events-auto rounded-lg shadow-lg border p-4 flex items-center space-x-3 transition-colors duration-300"
