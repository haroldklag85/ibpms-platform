...
@WebMvcTest(controllers = {DeploymentController.class, ProcessLifecycleControllerIT.TestArchiveController.class}) // Temporalmente alojado aquí por contexto
@Import({SecurityConfig.class, ProcessLifecycleControllerIT.TestConfig.class})
class ProcessLifecycleControllerIT extends BaseWebMvcIT {
