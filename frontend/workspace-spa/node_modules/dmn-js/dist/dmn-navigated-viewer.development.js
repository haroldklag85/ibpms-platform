/*!
 * dmn-js - dmn-navigated-viewer v14.7.1
 *
...
(function (global, factory) {
  ...
  function forEach$3(collection, iterator) {
    ...
    var convertKey = isArray$5(collection) ? toNum$3 : identity$3;
  ...
  var Manager = /*#__PURE__*/function () {
    ...
    function Manager() {
      ...
      _defineProperty$8(this, "_viewsChanged", function () {
    ...
    */
    ...
    _createClass(Manager, [{
      ...
      value: function _createViewer(id) {
        ...
        return new Viewer(_objectSpread$2(_objectSpread$2(_objectSpread$2({}, commonOptions), providerOptions), {}, {
  ...
  Canvas.prototype.viewbox = function (box) {
    ...
    var innerBox, matrix, activeLayer, transform$1, scale, x, y;
    if (!box) {
  ...
  function InteractionEvents(eventBus, elementRegistry, styles) {
    ...
    eventBus.on(['shape.changed', 'connection.changed'], LOW_PRIORITY$4, function (event) {
      var element = event.element,
        gfx = event.gfx;
  ...
  *
  ...
  Overlays.prototype.remove = function (filter) {
    ...
    forEach$3(overlays, function (overlay) {
      ...
      if (overlay) {
        remove$3(overlay.html);
        remove$3(overlay.htmlContainer);
  ...
  var _excluded$6 = ["additionalModules", "canvas"];
  ...
  Viewer$4.prototype._init = function (container, options) {
    var additionalModules = options.additionalModules,
      ...
      additionalOptions = _objectWithoutProperties$4(options, _excluded$6);
    var baseModules = options.modules || this.getModules(),
      staticModules = [{
        drd: ['value', this]
      }];
    var modules = [].concat(staticModules, _toConsumableArray(baseModules), _toConsumableArray(additionalModules || []));
    var diagramOptions = _objectSpread$1(_objectSpread$1({}, additionalOptions), {}, {
      canvas: _objectSpread$1(_objectSpread$1({}, canvas), {}, {
        container: container
      }),
      modules: modules
    });
  ...
  Viewer$4.prototype._modules = [CoreModule$1, TranslateModule, SelectionModule, OverlaysModule, DefinitionPropertiesModule, DrillDownModule];
    ...
    _createClass(Table, [{
      ...
      value: function _init(options) {
        var modules = options.modules,
          config = _objectWithoutProperties$5(options, _excluded$5);
        return {
          modules: modules,
          config: config
        };
  ...
  function add(set, element) {
    ...
    if (index[element]) {
      ...
      return {
        ...
        index: _objectSpread2(_objectSpread2({}, index), {}, _defineProperty$9({}, element, true))
      };
    }
  }
  ...
  var _excluded$4 = ["className", "elementId", "coords"];
    ...
    _createClass(BaseCell, [{
      ...
      value: function getRenderProps() {
        var _this$props = this.props,
          ...
          props = _objectWithoutProperties$5(_this$props, _excluded$4);
  ...
  var ComponentWithSlots = {
    slotFill: function slotFill(slotProps, DefaultFill) {
      var type = slotProps.type,
        ...
        props = _objectWithoutProperties$3(slotProps, _excluded$3);
    ...
    slotFills: function slotFills(slotProps) {
      var type = slotProps.type,
        context = slotProps.context,
        props = _objectWithoutProperties$3(slotProps, _excluded2);
  ...
  var AnnotationHeader = /*#__PURE__*/function (_Component) {
    ...
    function AnnotationHeader(props, context) {
      ...
      _this = _super.call(this, props, context);
      _defineProperty$5(_assertThisInitialized(_this), "onElementsChanged", function () {
        _this.forceUpdate();
      });
  ...
  var DecisionTableProperties = /*#__PURE__*/_createClass(function DecisionTableProperties(components) {
    ...
    components.onGetComponent('table.before', LOW_PRIORITY$1, function () {
      return DecisionTablePropertiesComponent;
    });
  });
  ...
  var ExpressionLanguages = /*#__PURE__*/function () {
    ...
    _createClass(ExpressionLanguages, [{
      ...
      value: function _getLanguageByValue(value) {
        return find$1(this.getAll(), function (language) {
  ...
  var HitPolicy = /*#__PURE__*/function (_Component) {
    ...
    _createClass(HitPolicy, [{
      ...
      value: function render() {
        ...
        var hitPolicyEntry = find$1(HIT_POLICIES, function (entry) {
  ...
  var _excluded$2 = ["modules", "additionalModules"];
   ...
   * @typedef {import('dmn-js-shared/lib/base/View).OpenError} OpenError
   */
  var Viewer$3 = /*#__PURE__*/function (_Table) {
    ...
    _createClass(Viewer, [{
      ...
      value: function _init(options) {
        var modules = options.modules,
          ...
          config = _objectWithoutProperties$2(options, _excluded$2);
   ...
   */
  var Viewer$2 = /*#__PURE__*/function () {
    function Viewer() {
      _classCallCheck(this, Viewer);
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var injector = options.injector;
  ...
  var PoweredByLogoComponent = /*#__PURE__*/function (_Component) {
    ...
    function PoweredByLogoComponent(props, context) {
      ...
      _classCallCheck(this, PoweredByLogoComponent);
      _this = _super.call(this, props, context);
      _defineProperty$1(_assertThisInitialized(_this), "onClick", function () {
        _this._eventBus.fire('poweredBy.show');
      });
      var injector = context.injector;
      _this._eventBus = injector.get('eventBus');
   ...
   * @typedef {import('dmn-js-shared/lib/base/View).OpenError} OpenError
   */
  var Viewer$1 = /*#__PURE__*/function (_BaseViewer) {
   ...
   * The dmn viewer.
   */
  var Viewer = /*#__PURE__*/function (_Manager) {
