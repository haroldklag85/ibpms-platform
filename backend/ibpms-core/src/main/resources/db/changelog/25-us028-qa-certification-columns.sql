...
ALTER TABLE ibpms_form_definitions ADD COLUMN IF NOT EXISTS is_qa_certified BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE ibpms_form_definitions ADD COLUMN IF NOT EXISTS certified_schema_hash VARCHAR(64);
ALTER TABLE ibpms_form_definitions ADD COLUMN IF NOT EXISTS certified_by VARCHAR(100);
ALTER TABLE ibpms_form_definitions ADD COLUMN IF NOT EXISTS certified_at TIMESTAMP;
