...
5. cat .agentic-sync/T-24_FE_Testability.md

TU MISIÓN:

1. Inyectar data-testid canónicos en BpmnDesigner.vue, DmnIntelligence.vue, WorkdeskView.vue.
2. Cada componente debe exponer selectores estables para Playwright.
3. NO refactorices lógica de negocio — solo inyecta atributos HTML.
4. Build: npm run build
5. Commit: git add . && git commit -m "feat(testability): inject data-testid for J-02" && git push origin sprint-6

REGLAS INQUEBRANTABLES:
- Solo rol de estabilización: NO cambies lógica, stores, ni rutas.
- PROHIBIDO eliminar componentes existentes.
- OBLIGATORIO documentar con // @Traceability: Testabilidad J-02 (T-24).
- PROHIBIDO usar alert() o confirm() nativos (.cursorrules §5).
```
