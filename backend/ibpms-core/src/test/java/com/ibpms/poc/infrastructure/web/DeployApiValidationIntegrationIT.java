...
public class DeployApiValidationIntegrationIT extends AbstractIntegrationIT {
    ...
    void setUp() {
        ...
        this.token = jwtTokenProvider.generateToken(
                "BPMN_Release_Manager",
                java.util.Arrays.asList("ibpms_rol_BPMN_Release_Manager"),
                "tenant_alpha",
