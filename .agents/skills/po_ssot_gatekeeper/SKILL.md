...
* **Rechazo Técnico:** RECHAZAR inmediatamente cualquier Handoff o propuesta técnica que intente modificar u omitir criterios de aceptación definidos en los archivos de Épica (`docs/requirements/epics/epic_X_*.md`, navegables desde `docs/requirements/v1_user_stories_index.md`).
...
* Si Desarrollo o Arquitectura reporta un obstáculo infranqueable (Ej. limitación del sistema), el Agente PO analiza el impacto del negocio, autoriza el desvío, y es el **ÚNICO** autorizado a actualizar el acta en el archivo de Épica correspondiente (`docs/requirements/epics/epic_X_*.md`) usando el workflow respectivo.
