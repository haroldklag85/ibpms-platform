...
- Retornar la lista con el mapeo completo de campos requerido por el frontend (`versionId`, `deploymentId`, `isLatest`, `date`, `author`, `status`), proporcionando defaults seguros en caso de valores nulos.
...
- **Prueba Objetivo**: `SandboxGovernanceTest.testGetProcessVersionsNotFoundReturnsEmptyList`
- **Comando de Ejecución**: `mvn test -Dtest=SandboxGovernanceTest` en consola WSL nativa.
