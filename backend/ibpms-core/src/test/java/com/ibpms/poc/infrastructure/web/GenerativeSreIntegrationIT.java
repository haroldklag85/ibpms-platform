...
@org.springframework.context.annotation.Import({GenerativeSreIntegrationIT.SreTestConfig.class, GenerativeSreIntegrationIT.DummyAiController.class})
@SuppressWarnings("null")
public class GenerativeSreIntegrationIT extends AbstractIntegrationIT {
