...
public class ClaimIntegrationIT {
    ...
    public void setup() {
        ...
        supervisorToken = jwtTokenProvider.generateToken("super1", "super@example.com", "ROLE_SUPERVISOR", "tenantA", "team-beta");
    }
    ...
    public void testConcurrentClaim() throws InterruptedException {
        ...
        String user2Token = jwtTokenProvider.generateToken("user2", "user2@example.com", "ROLE_OPERARIO", "tenantA", "team-alpha");
        given()
