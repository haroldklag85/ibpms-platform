...
describe('FormDefinitionAPI (CA-89)', () => {
    ...
    it('should successfully GET form versions from /api/v1/design/form-definitions/{id}/versions', async () => {
        ...
        mock.onGet(`/design/form-definitions/${fakeFormId}/versions`).reply(200, expectedData);
        ...
        expect(mock.history.get[0].url).toBe(`/design/form-definitions/${fakeFormId}/versions`);
    });

    it('should successfully POST a new form version to /api/v1/design/form-definitions/{id}', async () => {
        const fakeFormId = 'FORM-123';
        const payload = {
        ...
        mock.onPost(`/design/form-definitions/${fakeFormId}`).reply(200, expectedResponse);
        ...
        expect(mock.history.post[0].url).toBe(`/design/form-definitions/${fakeFormId}`);
